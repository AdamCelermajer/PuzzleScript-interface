...
from .rules import DEFAULT_OUTPUT_PATH, PerceptRuleModel
...
class PerceptLiveRunner:
    def __init__(
        ...
        model: PerceptRuleModel | None = None,
        ...
        self.model = model or PerceptRuleModel(
