...
```bash
cd studies/goal_recognition/experiment
npm install
```
...
```bash
python -m studies.goal_recognition.experiment.prepare_artifacts
```
...
```text
studies/goal_recognition/experiment/artifacts/<run_id>/
```
...
```bash
python -m studies.goal_recognition.experiment.build_prompts --run-dir studies/goal_recognition/experiment/artifacts/<run_id>
```
