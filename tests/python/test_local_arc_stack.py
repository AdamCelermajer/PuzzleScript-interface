...
from engine.arcade_env import ArcadeEnv  # type: ignore[import-not-found]
from engine.types import GameAction, GameState  # type: ignore[import-not-found]
...
class LocalArcStackTests(unittest.TestCase):
    def test_toolkit_backed_env_can_talk_to_local_puzzlescript_arc_service(
        ...
        arc_service = subprocess.Popen(
            [sys.executable, "src/arc_agi_endpoint.py"],
            cwd=ROOT,
            env={
                **os.environ,
                "PYTHONPATH": SRC,
