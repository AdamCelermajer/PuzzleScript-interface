...
from side_quests.goal_recognition_review.review import apply_verification, load_rows, write_rows
...
Expected: import failure because `side_quests.goal_recognition_review` does not exist yet.
...
```bash
python -m side_quests.goal_recognition_review.review --help
```
...
Expected: import failure for `side_quests.goal_recognition_review.report`.
...
```bash
python -m side_quests.goal_recognition_review.report --help
```
